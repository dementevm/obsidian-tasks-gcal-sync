...
GitHub Actions uses Node.js 22 and runs the same clean install, audit, version consistency checks and production build on every push/PR. It also creates an installable ZIP artifact containing a `tasks-gcal-sync/` directory.
